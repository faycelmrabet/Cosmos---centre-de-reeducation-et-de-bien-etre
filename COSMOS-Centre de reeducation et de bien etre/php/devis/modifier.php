<?php
              ...
              seConnecter();
              $requete="select * from `pfc2a4`.`devis`;";
    ...
    <div class="container_12">
		...
		<?php while  ($oussama=mysql_fetch_array($resultat) ){ ?>
			<tr class="ligne">
				   ...
				   <td><a href="modifier.php?idR=<?php echo $oussama['id_devis']; ?>">modifier</a></td>
			</tr>
			<?php } ?>	
			</table>
		...
		$requete1="SELECT * 
FROM  `devis` where id_devis='$id_modifier1';";
		$resultat1=mysql_query($requete1);
		 while($oussama1=mysql_fetch_array($resultat1)) {?>
		
		<form name="form" action="valider.php" method="post">
		<table width="100">
				<tr>
				<td><input type="hidden" name="id_devis" value="<?php echo $oussama1['id_devis']?>"></td>
				</tr>
				<tr>
				...
				<tr>
				<td>prix:</td>
				<td><input type="text" name="prix" value="<?php echo $oussama1['prix']?>"/></td>
				</tr>
				<tr>
				<td>tva:</td>
				<td><input type="text" name="tva" value="<?php echo $oussama1['tva']?>"/></td>
				</tr>
				<tr>
				<td>net_a_payer:</td>
				<td><input type="text" name="net_a_payer" value="<?php echo $oussama1['net_a_payer']?>"/></td>
				</tr>
				</table>
