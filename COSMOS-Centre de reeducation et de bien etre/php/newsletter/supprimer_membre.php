   ...
   <section id="content"><div class="ic"></div>  
    ...
    <div class="container_12">
		...
		<span id="menu">
			...
			<div><a href="afficher_membre.php">Afficher newsletter</a></div>		
			<div><a href="supprimer_membre.php">Supprimer newsletter</a></div>
			</fieldset>
			</span>
		</span>
		...
		<div class="tableaux">
			...
			<tr class="ligne">
                   ...
                   <td> <?php echo $ines['titre']; ?></td>
                   <td> <?php echo $ines['courriel']; ?></td>
				   <td><?php echo $ines['date']; ?></td>
				   <td><a href="supprimer.php?idR=<?php echo $ines['id']; ?>">supprimer</a></td>
			</tr>
			<?php } ?>	
			</table>	
			</div>
