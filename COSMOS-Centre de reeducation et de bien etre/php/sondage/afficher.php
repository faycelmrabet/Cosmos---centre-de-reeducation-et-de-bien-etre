<?php
              ...
              seConnecter();
              $requete="SELECT s.id, s.id_sondage, s.reponse, s.nb_reponses, q.question
FROM sondage_reponses s
JOIN sondage_questions q ON s.id_sondage = q.id";
 ...
 <section id="content"><div class="ic"></div>  
    ...
    <div class="container_12">
		...
		<table border="1">
			...
			<?php while  ($ines=mysql_fetch_array($resultat) ){ ?>
			<tr class="ligne">
                   <td><?php echo $ines['id']; ?></td>
                   <td> <?php echo $ines['id_sondage']; ?></td>
                   <td> <?php echo $ines['reponse']; ?></td>
				   <td><?php echo $ines['nb_reponses']; ?></td>
				   <td><?php echo $ines['question']; ?></td>
			</tr>
			<?php  } ?>
			</table>  
		</fieldset>
