   ...
   <section id="content"><div class="ic"></div>  
    ...
    <div class="container_12">
		...
		<div class="tableaux">
			...
			while  ($oussama=mysql_fetch_array($resultat) ){ ?>
			<tr class="ligne">
				   ...
				   <td><a href="modifier_avis.php?idR=<?php echo $oussama['id_personne']; ?>">modifier</a></td>			   
			</tr>
			<?php  } ?>
			</table>  
		...
		$requete1="SELECT * FROM `pfc2a4`.`avis` where id_personne='$id_modifier1'";
		$resultat1=mysql_query($requete1);
		 while($oussama1=mysql_fetch_array($resultat1)) {?>
		 <form name="form" action="valider_modification_avis.php" method="post">
		 <table width="100">
				<tr>
				<td><input type="hidden" name="id_personne" value="<?php echo $oussama1['id_personne']?>"></td>
				</tr>
				<tr>				
				...
				<tr>
				<td class="colone">Objet:</td> <td><input type="text" name="objet" id="objet" value="<?php echo $oussama1['Objet']?>"/>*</td>
				</tr>
